	...
	for d in datasets:
		...
		for itr, (images_l, targets_l, path) in enumerate(loader[d]):
			...
			for bat in range(B):
				...
				colored_tensor[1, :2 , dec_outputs.int()[bat, 3, 1]-1:dec_outputs.int()[bat, 3, 1]+2, 413:417] = 1
				...
				#保存
				torchvision.utils.save_image(colored_tensor, os.path.join('/data1/liwenbo/projects/wang/result_save/val_result', f'val_{d}_{itr}.jpg'))
